...
function loginOPWithKakao() {
    ...
    Kakao.Auth.getStatusInfo(function(statusObj) {
        ...
        if (statusObj.status === 'connected') {
            ...
            let infor = {"id" : nowUser} // 서버로 해당 페이로드를 실어 REST POST
            ...
            xhr_check.onload = function () {
                if (xhr_check.status === 200) {
                    ...
                    if (results === "False") { // DB에 등록되지 않은 사용자이므로 경고창 후 로그인 차단
                        ...
                        alert("You do not have permission to access the AE page.\nPlease join or change your process to AE");
                ...
                success: function (authObj) {
                    ...
                    fetch(url, { method: 'GET', headers: headers })
                        ...
                        .then(payload => {
                            ...
                            let infor = {"id": nowUser}; // 서버에 전송될 Json 데이터 > 사용자 카카오 계정을 전달
